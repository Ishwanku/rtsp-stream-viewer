        ...
        try:
            ...
            if pid:
                ...
                s3_client.delete_objects(
                    ...
                    Delete={'Objects': [{'Key': f'streams/{stream_id}/{f}'} for f in s3_client.list_objects_v2(Bucket=settings.AWS_STORAGE_BUCKET_NAME, Prefix=f'streams/{stream_id}/').get('Contents', [{'Key': ''}]) if 'Key' in f]}
                )
